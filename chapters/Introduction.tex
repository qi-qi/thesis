...
The thesis is organized as follows. Chapter~\ref{ch:Background} gives the architecture overview of Google File System (GFS), Hadoop Distributed File System (HDFS), MySQL Cluster, Hop-HDFS and knowledge on concurrency  control of database management. In Chapter~\ref{ch:Locking}, we further discuss the concurrency control scheme on GFS, HDFS and Hop-HDFS and related limitations, following with a systematic performance assessment between HDFS and Hop-HDFS. In Chapter~\ref{ch:Design}, we provide a solution based on \textit{Optimistic Concurrency Control with Snapshot Isolation on Semantic Related Group} and demonstrate how we overcome the limitations. In Chapter~\ref{ch:evaluation}, we give a detailed evaluation of our solution with a significant performance improvement. Finally, Chapter~\ref{ch:conclusion} gives the conclusion and future work of the thesis.
