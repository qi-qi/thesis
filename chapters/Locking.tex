...
\noindent The \textit{id} is unique and atomically generated for each INode. With the \textit{id} and \textit{parent\_id} relationship, the hierarchy will be constructed correctly from the rows to be in-memory objects used by the name system.
