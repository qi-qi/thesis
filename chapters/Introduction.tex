...
\begin{itemize}
	\item First, we analyzes the limitation of HDFS's NameNode implementation, with focus on the namespace locking compared to the master's namespace locking mechanism in Google File System.
